...
using WeatherForecastService.Interceptors.Helpers;
...
public class ExceptionInterceptor : Interceptor
{
    ...
    UnaryServerMethod<TRequest, TResponse> continuation)
  {
    ...
    {
      throw e.Handle(context, _logger, request.TryGetPropertyValue("TraceId", $"{Guid.NewGuid():D}")!);
    }
  }
    ...
    ClientStreamingServerMethod<TRequest, TResponse> continuation)
  {
    ...
    {
      throw e.Handle(context, _logger, requestStream.Current.TryGetPropertyValue("TraceId", $"{Guid.NewGuid():D}")!);
    }
  }
